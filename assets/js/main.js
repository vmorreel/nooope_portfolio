...
function activeFooter(){
	var wind = $('html').height();
	var obj = $(".parallax").scrollTop();
	var footer = $(".footer").addClass("show");

	if (wind >1080) {		
		obj >= wind+1540 ? footer.addClass("show") : footer.hasClass("show") && footer.removeClass("show")
	} else if (wind <= 1080 && wind >900) {
		obj >= wind+1800 ? footer.addClass("show") : footer.hasClass("show") && footer.removeClass("show")
	} else if (wind <= 900 && wind >= 800) {
		obj >= wind+1880 ? footer.addClass("show") : footer.hasClass("show") && footer.removeClass("show")
	} else {
		obj >= wind+1970 ? footer.addClass("show") : footer.hasClass("show") && footer.removeClass("show")
	}
}
